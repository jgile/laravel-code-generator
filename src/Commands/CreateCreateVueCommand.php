...
class CreateCreateVueCommand extends ViewsCommandBase
{
    /**
     ...
     * @var string
     */
    protected $signature = 'create:create-vue
     ...
     * @var string
     */
    protected $description = 'Create a create-vue for the model.';
    ...
    protected function handleCreateView()
    {
        ...
        if ($this->canCreateView($destenationFile, $input->force, $resources)) {
            ...
            $this->createLanguageFile($input->languageFileName, $input->resourceFile, $input->modelName)
                ...
                ->info('Create vue was crafted successfully.');
        }
    }
